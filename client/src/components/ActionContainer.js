...
const ActionContainer = props => {
    ...
    const changeLocation = () => {
        return(
            <svg className="actionSVG changeLocation" style={{"fillRule":"evenodd","clipRule":"evenodd","strokeLinejoin":"round","strokeMiterlimit":"1.41421"}} version="1.1" viewBox="0 0 491 491" xmlSpace="preserve">
                <g>
    ...
    const hex = () => {
        return(
            <svg className="actionSVG hex" style={{"enableBackground":"new 0 0 360 360"}} version="1.1" viewBox="0 0 360 360" x="0px" y="0px" xmlSpace="preserve">
                <g id="XMLID_17_">
    ...
    const honor = () => {
        return(
            <svg className="actionSVG heart" style={{"enableBackground":"new 0 0 490 490"}} version="1.1" viewBox="0 0 490 490" x="0px" y="0px" xmlSpace="preserve">
    ...
    return(
        <div className="ActionContainer">action container
